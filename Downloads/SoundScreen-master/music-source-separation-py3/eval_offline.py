...
def eval():
    ...
    with tf.Session(config=EvalConfig.session_conf) as sess:
        ...
        data = Data(EvalConfig.DATA_PATH, TrainConfig.NOISE_DATA_PATH, TrainConfig.VOICE_DATA_PATH)
        mixed_wav, src1_wav, src2_wav, wavfiles = data.next_wavs_eval(EvalConfig.SECONDS, EvalConfig.NUM_EVAL)
        ...
        for i in range(len(wavfiles)):
            ...
            write_wav(pred_src1_wav[i], '{}/{}-{}'.format(EvalConfig.RESULT_PATH, name, 'background'))
