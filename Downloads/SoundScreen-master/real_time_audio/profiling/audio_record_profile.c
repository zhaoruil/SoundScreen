...
// program defines
#define SAMPLE_RATE       (48000) // higher sampling rate = less latency
#define FRAMES_PER_SAMPLE (530)   // 530 is the lowest we can go
...
#if PROFILE
#define PROFILE_TIME_H    (0)
#include <time.h>

clock_t start;
clock_t end;

#define PROFILE_OUT_PATH  ("profiling/profile_c.txt")
#define MAX_ITR           (1000)
uint32_t itr;
FILE *out;
#endif
